...
**
** History:
**   2005/07/26  A. Cudmore     | Cygwin version
**
******************************************************************************/
...
int main(int argc, char *argv[])
{
   ...
   */
   ...
   if ( Status == 0 )
   {
      ...
      */  
      Status = OS_MemRangeSet (1, CFE_PSP_MEM_EEPROM, eeprom_address, eeprom_size, CFE_PSP_MEM_SIZE_DWORD, 0 ); 
   ...
   */
   ...
   /*
   ** Let the main thread sleep, and do the 1hz timer from here.
   ** Linux and OS X versions use a timer for 1hz processing.
   */     
   for ( ;; )
   {
