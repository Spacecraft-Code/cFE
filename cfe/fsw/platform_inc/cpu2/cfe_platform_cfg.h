...
** Revision 1.33 2014/09/09 14:00:18GMT-05:00 lwalling 
...
** Revision 1.31 2014/08/19 15:01:27EDT sstrege
...
** Revision 1.29 2012/01/18 16:37:22EST jmdagost
** Changed filename reference in cFE Mission Revision comment.
** Revision 1.28 2012/01/06 17:15:12EST lwalling
** Changed default shell output filename from CmdString.out to ShellCmd.out
** Revision 1.27 2011/12/27 16:38:45EST lwalling
** Include mission config file from platform config file
** Revision 1.26 2011/12/21 15:08:47EST lwalling
** Add table file verification definitions for spacecraft ID and processor ID
** Revision 1.25 2011/11/30 15:13:22EST jmdagost
** Changed definitions to be TRUE/FALSE instead of commenting/uncommenting them.
** Revision 1.24 2011/01/18 16:06:18EST lwalling
** Make sending 1hz command packet a configuration option
** Revision 1.23 2010/11/23 15:26:30EST jmdagost
** Added mission-specific revision number definition (4th digit in cFE version number)
** Revision 1.22 2010/11/23 12:10:38EST jmdagost
** Increased SB Max block size to accommodate change in SB.
** Revision 1.21 2010/11/08 16:18:42EST acudmore
** Updated RAM disk path comments
** Revision 1.20 2010/11/08 14:54:54EST aschoeni
** Moved CFE_SB_DEFAULT_MSG_LIMIT from cfe_sb_priv to cfe_platform_cfg
** Revision 1.19 2010/11/08 12:29:53EST acudmore
** Updated CFE_ES_MAX_PROCESSOR_RESETS to 2 ( rather than 5 )
** Revision 1.18 2010/11/05 15:54:29EDT aschoeni
** Added Generic Counter API to ES
** Revision 1.17 2010/11/04 16:41:43EDT aschoeni
** Added optional sender information storage
** Revision 1.16 2010/11/04 12:48:57EDT acudmore
** Added RAM disk mount path configuration item.
** Revision 1.15 2010/10/27 16:34:41EDT jmdagost
** Changed EVS default log mode from 0 (overwrite) to 1 (discard)
** Revision 1.14 2010/10/26 16:29:26EDT jmdagost
** Deleted unnecessary CFE_ES_MAX_SHELL_CMD_SIZE
** Revision 1.13 2010/10/20 12:43:52EDT jmdagost
** Added reference to CFE_ES_PoolCreateNoSem in documentation.
** Revision 1.12 2009/07/31 14:07:03EDT aschoeni
** Added note to parameters which may affect USER_RESERVED_MEM
** Revision 1.11 2009/07/30 19:27:48EDT jmdagost
** Updated doxygen comments for CFE_TBL_MAX_CRITICAL_TABLES
** Revision 1.10 2009/07/28 18:04:43EDT jmdagost
** Increased default number of registered CDS blocks
** Revision 1.9 2009/07/28 17:16:22EDT jmdagost
** Added initial filter mask and trigger mask definitions.
** Revision 1.8 2009/02/26 17:43:20EST rmcgraw
** Member moved from cfe_platform_cfg.h in project c:/MKSDATA/MKS-REPOSITORY/MKS-CFE-PROJECT/fsw/build/cpu2/inc/project.pj to cfe_platform_cfg.h in project c:/MKSDATA/MKS-REPOSITORY/MKS-CFE-PROJECT/fsw/platform_inc/cpu2/project.pj.
** Revision 1.7 2009/02/26 17:43:20ACT rmcgraw
** DCR6805:1 Added comments to reflect SB cfg paramater limits
** Revision 1.6 2009/02/11 15:04:22EST rmcgraw
** DCR6269:1 Added SB mem pool block sizes
** Revision 1.5 2008/12/08 12:07:14EST dkobe
** Updates to correct doxygen errors
** Revision 1.4 2008/08/06 22:42:30EDT dkobe
