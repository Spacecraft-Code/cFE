...
** Revision 1.33 2014/09/09 14:00:58GMT-05:00 lwalling 
** Describe effects of removing Table Services from CFE on definition of CFE_ES_MAX_BLOCK_SIZE
** Revision 1.32 2014/08/21 15:29:46EDT rmcgraw 
** DCR22696:1 Added #define CFE_ES_EXCEPTION_FUNCTION
** Revision 1.31 2014/08/19 15:01:26EDT sstrege
** Updated reference to OS_BSPGetUserReservedArea to CFE_PSP_GetUserReservedArea
** Revision 1.30 2014/04/14 11:51:40EDT lwalling
** Created platform config definitions for Time 1HZ and Time TONE task priorities and stack sizes
** Revision 1.29 2012/01/18 16:37:31EST jmdagost
** Changed filename reference in cFE Mission Revision comment.
** Revision 1.28 2012/01/06 17:15:01EST lwalling
** Changed default shell output filename from CmdString.out to ShellCmd.out
** Revision 1.27 2011/12/27 16:38:30EST lwalling
** Include mission config file from platform config file
** Revision 1.26 2011/12/21 15:08:57EST lwalling
** Add table file verification definitions for spacecraft ID and processor ID
** Revision 1.25 2011/11/30 15:13:20EST jmdagost
** Changed definitions to be TRUE/FALSE instead of commenting/uncommenting them.
** Revision 1.24 2011/01/18 16:06:29EST lwalling
** Make sending 1hz command packet a configuration option
** Revision 1.23 2010/11/23 15:26:28EST jmdagost
** Added mission-specific revision number definition (4th digit in cFE version number)
** Revision 1.22 2010/11/23 12:10:33EST jmdagost
** Increased SB Max block size to accommodate change in SB.
** Revision 1.21 2010/11/08 16:18:55EST acudmore
** Updated RAM disk path comments
** Revision 1.20 2010/11/08 14:54:47EST aschoeni
** Moved CFE_SB_DEFAULT_MSG_LIMIT from cfe_sb_priv to cfe_platform_cfg
** Revision 1.19 2010/11/08 12:31:00EST acudmore
** Updated CFE_ES_MAX_PROCESSOR_RESETS to 2 ( rather than 5 )
** Revision 1.18 2010/11/05 15:54:28EDT aschoeni
** Added Generic Counter API to ES
** Revision 1.17 2010/11/04 16:41:41EDT aschoeni
** Added optional sender information storage
** Revision 1.16 2010/11/04 12:49:05EDT acudmore
** Added RAM disk mount path configuration item.
** Revision 1.15 2010/10/27 16:34:40EDT jmdagost
** Changed EVS default log mode from 0 (overwrite) to 1 (discard)
** Revision 1.14 2010/10/26 16:29:25EDT jmdagost
** Deleted unnecessary CFE_ES_MAX_SHELL_CMD_SIZE
** Revision 1.13 2010/10/20 12:44:19EDT jmdagost
** Added reference to CFE_ES_PoolCreateNoSem in documentation.
** Revision 1.12 2009/07/31 14:06:29EDT aschoeni
** Added note to parameters which may affect USER_RESERVED_MEM
** Revision 1.11 2009/07/30 19:28:17EDT jmdagost
** Updated doxygen comments for CFE_TBL_MAX_CRITICAL_TABLES
** Revision 1.10 2009/07/28 18:04:40EDT jmdagost
** Increased default number of registered CDS blocks
** Revision 1.9 2009/07/28 17:16:20EDT jmdagost
** Added initial filter mask and trigger mask definitions.
** Revision 1.8 2009/02/26 17:44:06EST rmcgraw
** Member moved from cfe_platform_cfg.h in project c:/MKSDATA/MKS-REPOSITORY/MKS-CFE-PROJECT/fsw/build/cpu3/inc/project.pj to cfe_platform_cfg.h in project c:/MKSDATA/MKS-REPOSITORY/MKS-CFE-PROJECT/fsw/platform_inc/cpu3/project.pj.
** Revision 1.7 2009/02/26 17:44:06ACT rmcgraw
** DCR6805:1 Added comments to reflect SB cfg paramater limits
** Revision 1.6 2009/02/11 15:06:59EST rmcgraw
** DCR6269:1 Added SB mem pool block sizes
** Revision 1.5 2008/12/08 12:07:13EST dkobe
** Updates to correct doxygen errors
** Revision 1.4 2008/08/06 22:42:29EDT dkobe
** Added CFE_TIME_RegisterSynchCallback, CFE_TIME_UnregisterSynchCallback and CFE_TIME_CleanUpApp
** Revision 1.3 2008/07/28 14:34:15EDT apcudmore
** Increased RAM disk number of sectors parameter from 2048 to 4096
** Revision 1.2 2008/07/25 12:49:06EDT dkobe
** Updated CFE_TBL_MAX_DBL_TABLE_SIZE and CFE_TBL_SNGL_TABLE_SIZE to 16K
** Revision 1.1 2008/07/22 16:53:38EDT apcudmore
** Member moved to .../fsw/build/cpu3/inc
** Revision 1.1 2008/04/17 08:02:17EDT ruperera
** Member moved from cfe project on tlserver to cfe project on tlserver3
** Revision 1.6 2008/02/13 15:48:41EST rjmcgraw
** DCR6754:1 Removed CFE_SB_EVENT_LOG_ENTRIES
** Revision 1.5 2007/09/25 10:04:35EDT apcudmore
** Created new config parameter for default filename for Query All Tasks cmd.
** Revision 1.4 2007/09/20 11:19:08EDT apcudmore
...
**
**  \par Limits
**       Applies only if #CFE_TIME_CFG_SERVER is set to TRUE and #CFE_TIME_CFG_SOURCE is
**       also set to TRUE.
*/
