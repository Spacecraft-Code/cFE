...
#include \"%s_perf_ids.h\"
#include \"%s_cmd_ids.h\"
#include \"%s_cmd_codes.h\"
#include \"%s_tlm_ids.h\"

#include \"%s_%s_types.h\"

#include \"%s_private_ids.h\"
#include \"%s_private_types.h\"\n""" \
    % (tmpStr, tmpStr, ucMission, ucMission, ucMission, ucMission, \
       ucMission, lcApp, lcApp, lcApp)
...
/*
** These message Ids are defined in $(CFS_APP_SRC)/inc/%s_cmd_ids.h.
** Note that the header file is auto-generated from the Command & Data Dictionary (CDD).
**     %s_CMD_MID
**     %s_SEND_HK_MID
**     %s_WAKEUP_MID
**
** These command code Ids are defined in $(CFS_APP_SRC)/inc/%s_cmd_codes.h.
** Note that the header file is auto-generated from the CDD.
**     %s_NOOP_CC
**     %s_RESET_CC
**
** These message Ids are defined in $(CFS_APP_SRC)/inc/%s_tlm_ids.h.
** Note that the header file is auto-generated from the CDD.
**     %s_HK_TLM_MID
**     %s_OUT_DATA_MID
**
** These performance Ids are defined in $(CFS_APP_SRC)/inc/%s_perf_ids.h.
**     %s_MAIN_TASK_PERF_ID
**     %s_XXX_PERF_ID
*/
...
**=====================================================================================*/
    """ % (tmpStr, tmpStr, g_Mission, ucApp, ucApp, ucApp, ucMission, ucApp, ucApp, \
           ucMission, ucApp, ucApp, ucMission, ucApp, ucApp, ucApp, ucApp, ucApp, ucApp, \
...
**=====================================================================================*/
    """ % (tmpStr, tmpStr, ucApp, tmpStr, lcApp)
